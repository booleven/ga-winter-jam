...
var initial_tile_resources: Array[TileResource] = [
	preload("res://resources/data/tiles/clubs.tres"),
	preload("res://resources/data/tiles/diamonds.tres"),
	preload("res://resources/data/tiles/hearts.tres"),
	preload("res://resources/data/tiles/spades.tres")
]
